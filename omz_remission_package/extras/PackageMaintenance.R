...
OhdsiRTools::checkUsagePackage("omz12061")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/omz12061.pdf")
shell("R CMD Rd2pdf ./ --output=extras/omz12061.pdf")
...
OhdsiRTools::createRenvLockFile("omz12061")
