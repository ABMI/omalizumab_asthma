...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3006504)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3006504)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3011708)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3011708)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40480257)
...
WHERE V.visit_concept_id in (9203,262,9201,32037)
-- End Condition Occurrence Criteria
...
) leukocyte ON C.person_id = leukocyte.person_id AND C.measurement_date = leukocyte.measurement_date
WHERE C.value_as_number * leukocyte.value_as_number * 10 >= 150
