...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (2025590,2026120,2026115,2026105,2026111,2025575,2025576,2025579,2026090,2026088,42920039)
...
WHERE V.visit_concept_id in (9203,262,9201,581382,32037)
