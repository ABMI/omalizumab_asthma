...
options(fftempdir = "C:/Users/hihip/OneDrive - Ajou University/important/study/이카루스OMZ/omz11101/temp")

# Maximum number of cores to be used:
maxCores <- parallel::detectCores()

# The folder where the study intermediate and result files will be written:
outputFolder <- "C:/Users/hihip/OneDrive - Ajou University/important/study/이카루스OMZ/omz11101/output"
