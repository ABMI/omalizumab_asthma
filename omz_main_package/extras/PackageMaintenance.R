...
OhdsiRTools::checkUsagePackage("omz11101")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/omz11101.pdf")
shell("R CMD Rd2pdf ./ --output=extras/omz11101.pdf")
...
OhdsiRTools::createRenvLockFile("omz11101")
